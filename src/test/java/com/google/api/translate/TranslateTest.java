...
public class TranslateTest extends TestCase {
	...
	public void testHttpReferrerRequired() throws Exception {
		...
		try {
			translate.execute("Hello world", Language.ENGLISH, Language.UKRANIAN);
	...
	public void testTranslate() throws Exception {
		...
		assertEquals("Bonjour Le Monde", translate.execute("Hallo welt", Language.AUTO_DETECT, Language.UKRANIAN));
	}
	...
	public void testUnHtmlEntities() throws Exception {
		...
		assertEquals("זיהוי", translate.execute("ID", Language.ENGLISH, Language.UKRANIAN));
	}
	...
	public void testTranslateMultipleTexts() throws Exception {
		...
		final String[] results = translate.execute(new String[] {
			"Hello world",
			"See you soon"
		}, Language.ENGLISH, Language.UKRANIAN);
	...
	public void testExample() throws Exception {
		...
		assertEquals("Hello World", translate.execute("Bonjour le monde", Language.UKRANIAN, Language.ENGLISH));
	}
